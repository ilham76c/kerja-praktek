  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- MENU 'Kelola Berita' -->  
        <li class="active">          
          <a href="#"><i class="fa fa-newspaper-o"></i>Kelola Berita</a>
        </li>
        <!-- MENU 'Kelola Sosmed' -->        
        <li>          
            ...
            <div class="box-body">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  ...
                  <a href="<?php echo site_url('admin/form/tambah'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus">&nbsp;</i>Tambah Berita</a>
                </div>
              </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class="">
                      <tr>
                        ...
                        <th style="min-width: 400px;">Isi</th>
                      ...
                      <?php
                        ...
                        foreach ($data as $row) :?>                      
                          <tr>
                            ...
                            <td><img src="<?php echo base_url(); ?>upload/img-berita/<?php echo $row->gambar; ?>" width="120"></td>
                            <td><?php echo substr($row->isi, 0, 400).'...'; ?></td>
                            <td><?php echo $row->tanggal; ?></td>
                            <td>
                              <!-- <a href="<?php //echo site_url('admin/form/edit?id='.$row->id.''); ?>">Edit</a>  -->
                              <?=anchor("admin/form/edit/?id=".$row->id,"<i class='fa fa-edit'></i>Edit",array('onclick' => "return confirm('Edit data?')"))?>
                              &nbsp;|&nbsp;
                              <!-- <a href="<?php //echo site_url('admin/hapusBerita/'.$row->id.''); ?>">Delete</a> -->
                              <?=anchor("admin/form_aksi/delete/".$row->id,"<i class='fa fa-remove'></i>Delete",array('onclick' => "return confirm('Hapus data?')"))?>
                            </td>
